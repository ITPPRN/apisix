...
deploy_upstream "p2p-upstream" "host.docker.internal:8000"

deploy_service "front-p2p" "$SERVICE_P2P_CLIENT_ID" "$SERVICE_P2P_CLIENT_SECRET" "http://localhost:19080/front-p2p/callback" "http://localhost:19080/front-p2p/login" "$P2P_GATEWAY_SECRET"
